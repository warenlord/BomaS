...
export function UploadDropzone() {
  ...
  return (
    <div
      ...
      className={cn(
        "flex cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-border/70 bg-muted/30 px-6 py-10 text-center transition-colors",
    ...
    >
      ...
      {isUploading ? (
        <>
          ...
          <p className="text-xs text-muted-foreground">Cela peut prendre jusqu&apos;à une minute.</p>
        </>
      ) : (
        <>
